(()=>{
 ...
 function renderAccount(){const foot=$('.sidebar-foot');if(!foot)return;const name=signedInName();foot.innerHTML=`<a class="ux-account" href="#profile"><span>${esc(name||'Cuenta')}</span></a>`}
