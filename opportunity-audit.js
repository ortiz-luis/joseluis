(() => {
  ...
  state.opportunities=(state.opportunities||[]).filter(o=>!EXCLUDED_IDS.has(o.id)&&o.status!=='excluded'&&o.priority!=='No elegible');
  ...
  if(typeof sync==='function'){
    sync=function(o){
      for(const q of o.requirements||[]){
        ...
        q.state=actualReady(q.category)?'ready':'action';
      }
    };
  }
